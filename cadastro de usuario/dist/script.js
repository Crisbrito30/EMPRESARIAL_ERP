document.getElementsByTagName("h1")[0].style.fontSize = "6vw";let btn = document.querySelector('#verSenha')
...
function cadastrar(){
  if(validNome && validUsuario && validSenha && validConfirmSenha){
    ...
    setTimeout(()=>{
        window.location.href = 'http://127.0.0.1:5500/cadastro%20de%20usuario/lista_usuarios.html'
    }, 3000)
